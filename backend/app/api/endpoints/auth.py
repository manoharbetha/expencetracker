...
async def register(request: Request, response: Response, user_data: UserRegister = Body(...)) -> TokenResponse:
...
@limiter.limit("5/minute")
async def login(request: Request, response: Response, user_data: UserLogin = Body(...)) -> TokenResponse:
